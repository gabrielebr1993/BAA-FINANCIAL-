...
// overlay; se puede IMPRIMIR (@media print, deja solo el ticket) o descargar en PDF.
      ...
      <div className="mx-auto max-w-sm" onClick={(e) => e.stopPropagation()}>
        <div className="no-print mb-3 flex items-center gap-2">
          ...
          <div className="ml-auto flex items-center gap-2">
            <button onClick={() => window.print()} className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-brand-navy dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"><Printer size={16} /> {t('Imprimir')}</button>
