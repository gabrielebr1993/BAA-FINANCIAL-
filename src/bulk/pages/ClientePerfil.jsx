  ...
  return (
    <div className="w-full">
      ...
      <Card className="mb-4 overflow-hidden p-0">
        ...
        {/* Avatar SOLO sobre el degradado; el nombre va debajo (igual que el perfil
            del transportista y del chofer, sin taparse). */}
        <div className="px-5 pb-5">
          <div className="-mt-12 grid h-20 w-20 place-items-center rounded-2xl border-4 border-white bg-emerald-500 text-3xl font-black text-white shadow-lg dark:border-slate-900">{inicial}</div>
