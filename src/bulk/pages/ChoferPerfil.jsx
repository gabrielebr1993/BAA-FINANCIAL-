...
export default function ChoferPerfil() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
        ...
        <div className="px-5 pb-5">
          <div className="-mt-10 flex items-end gap-4">
            ...
            <div className="pb-1">
              ...
              <div className="mt-0.5 flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400"><User size={12} /> {t('Chofer')}</div>
            </div>
          </div>
      ...
      <Card className="p-4">
        <h3 className="m-0 mb-3 text-sm font-bold text-brand-navy dark:text-slate-100">{t('Órdenes')}</h3>
