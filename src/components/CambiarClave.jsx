// Package · Cambio de contraseña self-service: el usuario pone su clave ACTUAL y
// la NUEVA. Reautentica y actualiza en Firebase Auth. No requiere backend.
import { useState } from 'react'
import { EmailAuthProvider, reauthenticateWithCredential, updatePassword } from 'firebase/auth'
import { KeyRound, X } from 'lucide-react'
import { auth } from '../firebase'
import { Boton, Input, Aviso } from './ui'
